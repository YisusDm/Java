...
public class Inventario2 extends javax.swing.JFrame {
    ...
    PreparedStatement ps = null;
        try {
            ...
            int Fila = tableinv.getSelectedRow();
            String ReferenciaProducto = tableinv.getValueAt(Fila, 0).toString();

            ps = conn.prepareStatement("DELETE FROM inventario WHERE ReferenciaProducto=?");
            ...
            JOptionPane.showMessageDialog(null, "Error al Eliminar la referencia del producto");
