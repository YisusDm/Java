                    ...
                    if (!tel.isEmpty()) {
                        if (!corre.isEmpty()){
                                ...
                                try {
                                    ...
                                    JOptionPane.showMessageDialog(null, "Por favor ingrese el correo del proveedor");
                                }
                            } else {
                                JOptionPane.showMessageDialog(null, "Por favor ingrese el telefono del proveedor");
                            }
                        } else {
                            JOptionPane.showMessageDialog(null, "Por favor ingrese el producto que necesita");
                        }
                    } else {
